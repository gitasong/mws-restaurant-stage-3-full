 ...
 */
self.initMap = async () => {  // initMap() and its methods and properties need to be called on self/window because webpack wraps everything in its own IIFE
  // load individual restaurant data
